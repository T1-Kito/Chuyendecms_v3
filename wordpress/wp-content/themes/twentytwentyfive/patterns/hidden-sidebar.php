...
<!-- wp:heading {"level":3,"style":{"typography":{"fontStyle":"normal","fontWeight":"600","textTransform":"uppercase","letterSpacing":"1.2px"}}} -->
<h3 class="wp-block-heading" style="font-style:normal;font-weight:600;letter-spacing:1.2px;text-transform:uppercase" aria-label="<?php echo esc_attr_x( 'Sidebar section: Categories', 'Accessible label for categories section', 'twentytwentyfive' ); ?>"><?php esc_html_e( 'Categories', 'twentytwentyfive' ); ?></h3>
<!-- /wp:heading -->
...
<!-- wp:heading {"level":3,"style":{"typography":{"fontStyle":"normal","fontWeight":"600","textTransform":"uppercase","letterSpacing":"1.2px"}}} -->
<h3 class="wp-block-heading" style="font-style:normal;font-weight:600;letter-spacing:1.2px;text-transform:uppercase" aria-label="<?php echo esc_attr_x( 'Sidebar section: Popular Tags', 'Accessible label for tags section', 'twentytwentyfive' ); ?>"><?php esc_html_e( 'Popular Tags', 'twentytwentyfive' ); ?></h3>
<!-- /wp:heading -->

<!-- wp:tag-cloud {"numberOfTags":12,"smallestFontSize":"12px","largestFontSize":"18px"} /-->
