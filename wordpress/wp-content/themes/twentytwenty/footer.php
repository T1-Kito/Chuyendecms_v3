...
<section id="footer" class="text-white" style="background:#007b5e;">
    <div class="container py-5">
        ...
        <div class="text-center mb-3">
            ...
            <a href="https://plus.google.com/" target="_blank" class="text-white mx-2"><i class="fa fa-google-plus fa-lg"></i></a>
        ...
        <div class="text-center small text-light">
            ...
            <p class="h6 mb-0">© All right Reversed. <a href="https://www.sunlimetech.com" class="text-warning">Sunlimetech</a></p>
        </div>
    </div>
</section>
